...
define internal i64 @partition({ptr, i64, i64, i64, i64} %arr, i64 %lo, i64 %hi) nounwind willreturn {
pre_entry:
...
define internal void @qsort({ptr, i64, i64, i64, i64} %arr, i64 %lo, i64 %hi) nounwind willreturn {
pre_entry:
  %arr.addr = alloca {ptr, i64, i64, i64, i64}, align 8
  %lo.addr = alloca i64, align 8
  %hi.addr = alloca i64, align 8
