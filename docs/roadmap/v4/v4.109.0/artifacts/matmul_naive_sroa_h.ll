...
while_body10:                                     ; preds = %while_header9
  %i.178 = mul nsw i64 %i.a.70.0, 64
  %i.182 = add nsw i64 %i.178, %k.a.164.0
  ...
  %i.191 = mul nsw i64 %k.a.164.0, 64
  %i.195 = add nsw i64 %i.191, %j.a.78.0
  ...
  %i.210 = add nsw i64 %sum.a.161.0, %i.206
  %i.216 = add nsw i64 %k.a.164.0, 1
  br label %while_header9

while_exit11:                                     ; preds = %while_header9
  %i.221 = mul nsw i64 %i.a.70.0, 64
  %i.225 = add nsw i64 %i.221, %j.a.78.0
