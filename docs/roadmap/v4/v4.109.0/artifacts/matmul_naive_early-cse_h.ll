...
while_exit5:                                      ; preds = %while_header3
  ...
  %rt.129 = call { ptr, i64 } @__mn_str_concat({ ptr, i64 } %l.127, { ptr, i64 } %rt.124)
