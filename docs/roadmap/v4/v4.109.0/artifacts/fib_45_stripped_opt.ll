; ModuleID = '/mnt/c/Users/Juan/Documents/GitHub/Mapanare/docs/roadmap/v4/v4.109.0/artifacts/fib_45_stripped.bc'
source_filename = "fib_45"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str.0 = private constant [10 x i8] c"fib(45) = ", align 8
...
define internal fastcc i64 @fib(i64 %n) unnamed_addr #0 {
pre_entry:
...
if_merge2:                                        ; preds = %pre_entry, %if_merge2
  ...
  %i.25 = add i64 %c.13, %accumulator.tr5
...
pre_entry:
  %c.2 = tail call fastcc i64 @fib(i64 45)
  ...
  tail call void @__mn_str_println({ ptr, i64 } %rt.14)
