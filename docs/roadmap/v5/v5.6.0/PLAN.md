# Mapanare v5.6.0 — "Sh.6: Self-Hosted Tensor"
...
**Prerequisite:** v5.5.0 shipped (Sh.4 async closed)
**Estimated work:** 3–4 sessions (~7–10 hours). Largest of the v5.5–
v5.7 feature-parity arc because it touches lexer + parser.
...
Tensor is the largest feature gap of the v5.5–v5.7 arc. The Python
