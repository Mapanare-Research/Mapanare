...
[![Versao](https://img.shields.io/badge/versao-5.27.0-blue.svg?style=flat-square)](../CHANGELOG.md)
...
O compilador auto-hospedado roda o corpus completo da v5.21.0 (95/95 goldens nativos):
...
Ponto fixo auto-hospedado de 3 estagios: STRICT (stage2.ll == stage3.ll byte-identicos em 238,086 linhas; restaurado v5.9.0; mantido atraves da reescrita mecanica de chaves para dois pontos em v5.17.0, da ergonomia de structs em v5.20.0, e das comparacoes encadeadas em v5.21.0 — sequencia mais longa na historia do projeto: 13 lancamentos consecutivos). Compilador auto-hospedado encolheu **-3,950 linhas (-13.8%)** desde v5.13.0 via a reescrita Sh.\* sem quebrar o ponto fixo.
