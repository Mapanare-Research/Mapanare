...
[![Versao](https://img.shields.io/badge/versao-5.13.0-blue.svg?style=flat-square)](../CHANGELOG.md)
...
O compilador auto-hospedado roda o corpus completo da v5.7.0 (66/66 goldens nativos):
...
Ponto fixo auto-hospedado de 3 estagios: NEAR (diferenca de 4 linhas de metadata VERSION num stage2.ll de 217k linhas).
