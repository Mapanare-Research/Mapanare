...
- **v3.32.0** (current) — **Sapoara.** Review hardening: 7 C runtime fixes, list return ownership, 21 new native tests (MnMap/MnSignal/MnStream/MnValue), 74/74 C tests pass.
