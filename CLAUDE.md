...
- **v3.42.0** (current) — Network Native: HTTP GET, SHA-256, base64, HMAC, regex builtins. 38 golden tests.
- **v3.43.0** (next) — Agent Runtime: link mapanare_runtime.c, spawn/send/sync with OS threads.
