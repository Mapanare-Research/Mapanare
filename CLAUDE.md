...
- **v4.91.0** (shipped) — Arc 12 panel: 8.57/10, PASS. 7 reviewers graded MIR optimizer (inlining, strength reduction, escape analysis). All passes semantically correct. Arc 12 closes.
