...
- **v4.82.0** (shipped) — Arc 11 release 1. Baseline benchmark suite: 5 workloads at O0/O1/O2, cross-language vs Python/Rust. fib within 15% of Rust. Measurement-only, no IR changes.
