...
- **v5.0.0** (when ready) — Major version tag. Gated by panel aggregate ≥ 9.0 AND 0 NEEDS WORK. Current attempts: v4.99.0 (6.59, fail), v4.120.0 (8.21, fail). Next planned attempt: v4.136.0 after Sh.2 (closed v4.132.0) + An.1 + Sh.11 land.
...
This project is indexed by GitNexus as **Mapanare** (23608 symbols, 56422 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
