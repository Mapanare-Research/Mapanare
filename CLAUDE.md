...
- **v3.27.0** (current) — **Guio.** Shared transpiler framework (`transpiler.mn`): TypeMapping, class→struct, exception→Result, stdlib shims, state management, 4 language mapping factories.
