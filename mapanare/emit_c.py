"""emit_c.py — MIR to C emitter for Mapanare (v3.34.0).
...
class CEmitter:
    ...
    def _emit_preamble(self) -> None:
        self._w("/* Generated by Mapanare v3.34.0 C emitter — do not edit. */")
    ...
    def _emit_map_init(self, inst: MapInit) -> None:
        ...
        val_tag = "MN_MAP_VAL_STR" if inst.val_type.kind == TypeKind.STRING else "MN_MAP_VAL_OPAQUE"
        self._w(f"{dest} = __mn_map_new({key_size}, {val_size}, {key_tag}, {val_tag});")
