...
pre_entry:
  ...
  %"a.t1" = alloca i64
  %"a.t2" = alloca {i64, i64}
  store {i64, i64} zeroinitializer, {i64, i64}* %"a.t2"
  %"a.t3" = alloca i64
  %"a.t4" = alloca {i8*, i64}
  store {i8*, i64} zeroinitializer, {i8*, i64}* %"a.t4"
  %"a.t5" = alloca i1
  br label %"entry"
entry:
  store i64 3, i64* %"a.t0"
  store i64 4, i64* %"a.t1"
  %"t2.f0" = insertvalue {i64, i64} undef, i64 3, 0
  %"t2.f1" = insertvalue {i64, i64} %"t2.f0", i64 4, 1
