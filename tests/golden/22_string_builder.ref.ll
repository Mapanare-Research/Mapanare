...
@.str.2 = private constant [1 x i8] c"-", align 8
...
pre_entry:
  ...
  %t2.a.10 = alloca ptr, align 8
  store ptr null, ptr %t2.a.10
  %has_next4.a.13 = alloca i1, align 8
  store i1 0, ptr %has_next4.a.13
  %next5.a.17 = alloca i64, align 8
  store i64 0, ptr %next5.a.17
  %str_track.21 = alloca {ptr, i64}, align 8
  store {ptr, i64} zeroinitializer, ptr %str_track.21
  %t6.a.22 = alloca {ptr, i64}, align 8
  store {ptr, i64} zeroinitializer, ptr %t6.a.22
  %range_free7.a.26 = alloca i1, align 8
  store i1 0, ptr %range_free7.a.26
...
entry:
  ...
  store ptr %c.9, ptr %t2.a.10
  br label %for_header0
for_header0:
  %l.11 = load ptr, ptr %t2.a.10
  %c.12 = call i1 @__iter_has_next(ptr %l.11)
  store i1 %c.12, ptr %has_next4.a.13
  %l.14 = load i1, ptr %has_next4.a.13
  br i1 %l.14, label %for_body1, label %for_exit2
for_body1:
  %l.15 = load ptr, ptr %t2.a.10
  %c.16 = call i64 @__iter_next(ptr %l.15)
  store i64 %c.16, ptr %next5.a.17
  %l.18 = load {ptr, i64}, ptr %result.a.5
  %l.19 = load {ptr, i64}, ptr %s.addr
  %rt.20 = call {ptr, i64} @__mn_str_concat({ptr, i64} %l.18, {ptr, i64} %l.19)
  store {ptr, i64} %rt.20, ptr %str_track.21
  store {ptr, i64} %rt.20, ptr %t6.a.22
  %l.23 = load {ptr, i64}, ptr %t6.a.22
  store {ptr, i64} %l.23, ptr %result.a.5
  br label %for_header0
for_exit2:
  %l.24 = load ptr, ptr %t2.a.10
  %c.25 = call i1 @__mn_range_free(ptr %l.24)
  store i1 %c.25, ptr %range_free7.a.26
  %l.27 = load {ptr, i64}, ptr %result.a.5
  ret {ptr, i64} %l.27
}
